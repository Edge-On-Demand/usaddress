...
latex_documents = [
    ('index', 'usaddress.tex', 'usaddress Documentation',
     'Cathy Deng, Forest Gregg', 'manual'),
]
...
man_pages = [
    ('index', 'usaddress', 'usaddress Documentation',
     ['Cathy Deng, Forest Gregg'], 1)
]
...
texinfo_documents = [
    ('index', 'usaddress', 'usaddress Documentation',
     'Cathy Deng, Forest Gregg', 'usaddress',
